...
class ArchethicTheme {
  ...
  static Color iconDataWidgetIconBackground =
      aedappfm.ArchethicThemeBase.neutral0.withValues(alpha: 0.1);

  // Menu
  static Color iconDrawer = aedappfm.ArchethicThemeBase.neutral0;
  static Color iconDrawerBackground =
      aedappfm.ArchethicThemeBase.neutral0.withValues(alpha: 0.2);
  ...
  static Color pickerItemIconDisabled =
      aedappfm.ArchethicThemeBase.neutral0.withValues(alpha: 0.6);
  ...
  static Color text60 =
      aedappfm.ArchethicThemeBase.neutral0.withValues(alpha: 0.6);
  static Color text45 =
      aedappfm.ArchethicThemeBase.neutral0.withValues(alpha: 0.45);
  static Color text30 =
      aedappfm.ArchethicThemeBase.neutral0.withValues(alpha: 0.3);
  static Color text20 =
      aedappfm.ArchethicThemeBase.neutral0.withValues(alpha: 0.2);
  static Color text15 =
      aedappfm.ArchethicThemeBase.neutral0.withValues(alpha: 0.15);
  static Color text10 =
      aedappfm.ArchethicThemeBase.neutral0.withValues(alpha: 0.1);
  static Color text05 =
      aedappfm.ArchethicThemeBase.neutral0.withValues(alpha: 0.05);
  static Color text03 =
      aedappfm.ArchethicThemeBase.neutral0.withValues(alpha: 0.03);
  ...
  static Color snackBarShadow =
      aedappfm.ArchethicThemeBase.neutral900.withValues(alpha: 0.8);
  ...
  static Color background40 =
      aedappfm.ArchethicThemeBase.neutral900.withValues(alpha: 0.4);
  ...
  static Color backgroundRecentTxListCardTransferOutput =
      aedappfm.ArchethicThemeBase.purple500.withValues(alpha: 0.2);
  ...
  static Color backgroundRecentTxListCardTransferInput =
      aedappfm.ArchethicThemeBase.raspberry500.withValues(alpha: 0.4);
  ...
  static Color divider =
      aedappfm.ArchethicThemeBase.blue700.withValues(alpha: 0.1);
  ...
  static Color bottomBarActiveTitleColor =
      aedappfm.ArchethicThemeBase.neutral0.withValues(alpha: 0.8);
  ...
  static Color overlay30 = const Color(0xFF000000).withValues(alpha: 0.3);
  static Color seedInfoBackground = Colors.grey.shade800.withValues(alpha: 0.5);
  ...
  static Gradient gradientInputFormBackground = LinearGradient(
    colors: [
      aedappfm.ArchethicThemeBase.neutral900.withValues(alpha: 1),
      aedappfm.ArchethicThemeBase.neutral900.withValues(alpha: 0.3),
    ],
    stops: const [0, 1],
  );
  ...
  static Color bannerShadowColor = Colors.white.withValues(alpha: 0.8);
